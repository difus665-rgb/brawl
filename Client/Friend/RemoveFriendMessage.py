        ...
        try:
            with conn.cursor() as cursor:
                ...
                if user and user[0]:
                    ...
                    friends = [friend for friend in friends if friend['id'] != self.LowID]
                ...
                if target_user and target_user[0]:
                    ...
                    target_friends = [friend for friend in target_friends if friend['id'] != self.player.low_id]
            ...
            print(f"[ERROR] MySQL error in RemoveFriendMessage: {e}")
        finally:
            if conn:
                conn.close()