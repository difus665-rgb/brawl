...
if __name__ == "__main__":
    print("[СИСТЕМА] Запуск сервера в безопасном автономном режиме (Без Бота)...")
    
    # 1. Сразу запускаем туннель
    start_playit_tunnel()
    time.sleep(2)
    
    # 2. Запускаем ТОЛЬКО чистый игровой сервер core.py.
    # Файлы 'anticheat.py' и 'botuser.py' полностью вырезаны, чтобы не было ошибки 409 и крашей базы данных!
    files = ['core.py']
