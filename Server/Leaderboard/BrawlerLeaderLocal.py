...
class BrawlerLeaderLocal(Writer):
    ...
    def encode(self):
        ...
        fetch = DataBase.GetLeaderboardByRegionBrawler(self, self.brawler, self.player.Region)
        ...
        for i in fetch:
            ...
            if trophies > 0:
                ...
                self.writeString("") # Club Name)  # Название клуба
